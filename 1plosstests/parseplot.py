...
ax.errorbar(means.index,means.curve0.values, label="SCTP")
ax.errorbar(means.index,means.curve1.values, label="S2-SCTP")
ax.errorbar(means.index,means.curve2.values, label="DTLS-over-SCTP")
